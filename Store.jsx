...
// let storedata = useCallback(async()=>{
//     // get brands from db
//     let brandsResponse = await fetch(`http://localhost:4000/brands`);
...
//     let categoryResponse = await fetch(`http://localhost:4000/categories`);
...
//  let productResponse = await fetch(`http://localhost:4000/products?productName_like=${txt}`)
